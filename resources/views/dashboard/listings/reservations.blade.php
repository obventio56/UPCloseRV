					...
					<div class="card">
						...
						<div class="grid">
							<div class="details">
								...
								<p class="dets"><span>Check in:</span> <span>{{ $listing->check_in }}</span></p>
						...
						<a data-fancybox="" data-src="#cancel-{{ $booking->id }}" data-modal="true" href="javascript:;" class="button brown round">Cancel Reservation</a>
...
@section('popup')
	@foreach($bookings as $booking)
	<div id="cancel-{{ $booking->id }}" class="p-5 fancybox-content" style="display: none;max-width: 900px;">
